...
function swap(){
    if(document.getElementById("option-1").checked){
        document.getElementById("comp-swap").innerText="replace";
        document.getElementById("box").style.animationComposition="replace";
    }
    else if(document.getElementById("option-2").checked){
        document.getElementById("comp-swap").innerText="add";
        document.getElementById("box").style.animationComposition="add";
    }
    else if(document.getElementById("option-3").checked){
        document.getElementById("comp-swap").innerText="accumulate";
        document.getElementById("box").style.animationComposition="accumulate";
    }
}